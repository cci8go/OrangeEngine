#
#  Be sure to run `pod spec lint OrangeEngineFramework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "一个橙子" => "153190953@qq.com" }
  # Or just: spec.author    = "一个橙子"
  # spec.authors            = { "一个橙子" => "153190953@qq.com" }
  # spec.social_media_url   = "https://twitter.com/一个橙子"
